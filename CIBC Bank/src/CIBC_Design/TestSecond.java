...
public class TestSecond {
	...
	public static void main(String[] args) {
		...
		//testing the copy constructors of credit and checking account
			...
			System.out.println(re1.getAccount().getAccountNumber());
			CheckingAccount bb1 = (CheckingAccount) re1.getAccount();
			System.out.println(bb1.getOverdraftOption());
			
			System.out.println(re1.getTime().toString());
			
			ca1.setOverdraftLimit(1300);
			System.out.println(ca1.getOverdraftLimit());
			System.out.println(bb1.getOverdraftLimit());
