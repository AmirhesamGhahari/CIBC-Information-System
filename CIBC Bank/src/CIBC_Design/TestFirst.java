...
public class TestFirst {
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------------------");
		// testing transfering the money between two credit acounts
		...
		System.out.println("-----------------------");
		// testing transfering the money between credit account and checking account
